...
void init_clay()
{
    ...
    Clay_Arena clay_arena = Clay_CreateArenaWithCapacityAndMemory(clay_mem_size, malloc(clay_mem_size));
    Clay_Initialize(clay_arena, (Clay_Dimensions){ 480, 272 }, (Clay_ErrorHandler){ 0 });
